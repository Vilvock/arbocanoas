...
class CustomAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  CustomAppBar({this.title: "", this.isVisibleBackButton = false, this.isVisibleNotificationsButton = false});

  @override
  Widget build(BuildContext context) {
    return AppBar(
      actions: _returnIcons(this.isVisibleNotificationsButton, context),
  ...
  List<Widget> _returnIcons(bool isVisibleNotificationsButton, BuildContext context) {
