...
class FilterAlertDialog extends StatefulWidget {
  ...
  FilterAlertDialog({Key? key, required this.speciesController, required this.localController, required this.managementController, required this.nbhController});
